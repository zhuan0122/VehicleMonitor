...
namespace CustomerMicroservice.Tests.ServiceTests
{
    public class CustomerVehicleServiceTest
    {
        ...
        ////    [Fact]
        ////    public void GetCustomerById_ExistingCustomerId_ShouldReturnCustomer()
        ////    {
        ////        // Arrange
        ////        var customers = new List<Customer>
        ////{
        ...
        ////    [Fact]
        ////    public void GetCustomerById_NonExistingCustomerId_ShouldReturnNull()
        ////    {
        ////        // Arrange
        ////        var customers = new List<Customer>
        ////{
        ...
        ////        // Act
        ////        var result = _customerVehicleService.GetCustomerById(nonExistingCustomerId);
        ...
        [Fact]
        public void GetVehiclesForCustomerId_ExistingCustomerId_ShouldReturnListOfVehicles()
        {
            // Arrange
        ...
        ////[Fact]
        ////public void GetVehiclesForCustomerId_NonExistingCustomerId_ShouldReturnEmptyList()
        ////{
        ////    // Arrange
        ////    _dbContext.Setup(x => x.Vehicles).Returns(DbSetMock.GetDbSetMock(new List<Vehicle>()));

        ////    // Act
        ////    var result = _customerVehicleService.GetVehiclesForCustomerId(1);

        ////    // Assert
        ////    Assert.Empty(result);
        ////}

        // Similar tests can be written for other methods like GetVehiclesByCustomerId.
    }
}